...
Route::get('/notes/{id}/children', [App\Http\Controllers\NoteController::class, 'getChildren']);
Route::get('/notes/{id}/parsedbody', [App\Http\Controllers\NoteController::class, 'getParsedBody']);
